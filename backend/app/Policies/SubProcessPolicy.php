...
class SubProcessPolicy
{
    ...
    {
        $map = $this->resolveMap($subProcess);
    ...
    public function create(User $user, Process $process): bool
    {
        $map = $this->resolveMapFromProcess($process);
    ...
    private function resolveMap(SubProcess $subProcess): ?ProcessMap
    {
        ...
        return $this->resolveMapFromProcess($process);
    }

    private function resolveMapFromProcess(Process $process): ?ProcessMap
    {
