...
class ProcessPolicy
{
    ...
    public function create(User $user, ProcessCategory $category): bool
    {
        $map = $this->resolveMapFromCategory($category);
    ...
    private function resolveMap(Process $process): ?ProcessMap
    {
        ...
        return $this->resolveMapFromCategory($category);
    }

    private function resolveMapFromCategory(ProcessCategory $category): ?ProcessMap
    {
