...
export default function EditClientModal({ client, franchiseId, onClose, onSave }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      await onSave(profilePayload, passwordPayload, client.id, franchiseId);
    } catch (error) {
      ...
      <div className="relative z-50 w-full max-w-lg mx-4 bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200">
          <h2 className="text-base font-semibold text-slate-800">
            {t('franchise_detail.edit_client_title')}
          </h2>
          <button
            type="button"
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} noValidate autoComplete="off">
          <div className="px-6 py-5 space-y-4 max-h-[70vh] overflow-y-auto">
            ...
            {/* Name */}
            <div>
              <label htmlFor="ec-name" className="block text-sm font-medium text-slate-700 mb-1">
            ...
            {/* Email */}
            <div>
              <label htmlFor="ec-email" className="block text-sm font-medium text-slate-700 mb-1">
            ...
            {/* Phone */}
            <div>
              <label htmlFor="ec-phone" className="block text-sm font-medium text-slate-700 mb-1">
            ...
            {/* Job Title */}
            <div>
              <label htmlFor="ec-job_title" className="block text-sm font-medium text-slate-700 mb-1">
            ...
            <div className="border-t border-slate-200 pt-4">
              ...
              {showPasswordSection && (
                <div className="mt-3">
                  ...
                  <label htmlFor="ec-password" className="block text-sm font-medium text-slate-700 mb-1">
