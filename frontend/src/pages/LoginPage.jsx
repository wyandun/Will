...
const FEATURES = [
  {
    ...
    title: 'Process Maps',
    description: 'Design and share BPMN workflows in English and Spanish',
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="1.75" viewBox="0 0 24 24">
    ...
    title: 'Contracts',
    description: 'Sign and manage legal documents with DocuSeal e-signing',
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="1.75" viewBox="0 0 24 24">
    ...
    description: 'Track income, expenses, and invoices with AI-assisted entry',
  },
];
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 flex-col items-center justify-center px-12 py-16">
        ...
        <p className="text-slate-300 text-lg font-medium text-center leading-snug max-w-xs mb-12">
          Empowering Latino businesses to grow in the USA
        </p>
