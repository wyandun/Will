...
export const franchisesApi = {
  ...
  // ── Sub-franchise creation ──────────────────────────────────────────────

  createSubFranchise: (data) =>
    apiClient.post('/franchises/sub', data).then((res) => res.data.data),

  // ── Sub-franchise listing for a given SM franchise ──────────────────────
  getSubFranchisesForFranchise: (franchiseId) =>
    apiClient.get(`/franchises/${franchiseId}/sub-franchises`).then((res) => res.data.data ?? []),
};